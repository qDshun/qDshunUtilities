...
export const HumanBodyParts = [
  new BodyPart('foot_right', 0.35, true),
  new BodyPart('foot_left', 0.35, true),
  new BodyPart('shin_right', 1.75, true),
  new BodyPart('shin_left', 1.75, true),
  new BodyPart('knee_right', 0.175, true),
  new BodyPart('knee_left', 0.175, true),
  new BodyPart('thigh_right', 1.575, true),
  new BodyPart('thigh_left', 1.575, true),
  new BodyPart('hand_right', 0.35, true),
  new BodyPart('hand_left', 0.35, true),
  new BodyPart('forearm_right', 0.875, true),
  new BodyPart('forearm_left', 0.785, true),
  new BodyPart('elbow_right', 0.175, true),
  new BodyPart('elbow_left', 0.175, true),
  new BodyPart('upperArm_right', 0.35, true),
  new BodyPart('upperArm_left', 0.35, true),
  new BodyPart('shoulder_right', 0.35, true),
  new BodyPart('shoulder_left', 0.35, true),
  new BodyPart('groin', 0.35, true),
  new BodyPart('abdomen', 1.75, true),
  new BodyPart('chest', 5.25, true),
  new BodyPart('neck', 0.35, true),
  new BodyPart('face', 0.7, true),
  new BodyPart('eyes', 1, true),
